...
import { View, StyleSheet, Image, Text, TouchableOpacity, TextInput, ScrollView, Dimensions, Alert, SafeAreaView, StatusBar, Platform, KeyboardAvoidingView } from 'react-native';
...
export default class EditProfile extends Component {
    ...
    getUserDetail() {
        ...
        ApiCaller.call('users/myprofile', "GET", null, true)
            .then((response) => {
                ...
                if (response) {
                    ...
                    console.log("profile Screen====>>>>", response.userDetails.phone_number)

                    this.setState({
                        firstName: response.userDetails.first_name, lastName: response.userDetails.last_name,
                        email: response.userDetails.email, profilePic: response.userDetails.profile_pic_path,
                        phoneNumber: response.userDetails.phone_number, formattedDate: response.userDetails.dob,
                        gender: response.userDetails.gender, address: response.userDetails.address,
                        value: response.userDetails.gender == 'Male' ? 1 : response.userDetails.gender == 'Female' ? 2 : 0,
                        location: response.userDetails.location
                    })

                    this.locationRef.setAddressText(response.userDetails.location)
    ...
    sortValueChange = (data, value) => {
        ...
        // this.locationRef.setAddressText(data.description)
    ...
    updateProfileCall() {
        ...
        formdata.append('phone_number', this.state.myNumber ? this.state.myNumber : this.state.phoneNumber)
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <SafeAreaView style={[profileStyle.statusColor]} />
                <SafeAreaView style={profileStyle.bottomColor}>
                    <View style={{ flex: 1 }}>
                        <CommonHeader
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='handled'>
                            <View style={[{ width: '100%', height: '100%', marginBottom: 20 }]}>
                                <View style={[profileStyle.createviewStyle]}>

                                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                        <TouchableOpacity activeOpacity={1} onPress={() => this.showActionSheet()} >

                                            {this.state.avatarSource != null ? < Image style={[profileStyle.createImage]} source={this.state.avatarSource} />
                                                :
                                                this.state.profilePic ? <Image style={[profileStyle.createImage]} source={{ uri: this.state.profilePic }} />
                                                    : <Image style={[profileStyle.createImage]} source={require('../../assets/images/ic_placeholder.png')} />
                                            }

                                        </TouchableOpacity>
                                        <Text style={[profileStyle.uploadImageText]}>Upload Profile Picture</Text>
                                    </View>



                                    <View style={{ flexDirection: 'row', marginTop: 50 }}>
                                        <View style={[profileStyle.createFirstView, { marginRight: 10, marginLeft: Platform.OS == 'ios' ? 0 : 2 }]}>
                                            <Text style={profileStyle.editText}>First Name</Text>
                                            <TextInput
                                                style={profileStyle.createInputStyle}
                                        ...
                                        <View style={profileStyle.createFirstView}>
                                            <Text style={[profileStyle.editText]}>Last Name</Text>
                                            <TextInput
                                                style={profileStyle.createInputStyle}
                                    ...
                                    <View style={[profileStyle.editView, { marginTop: 10 }]}>
                                        <Text style={profileStyle.editText}>Date of birth</Text>
                                        <DateTimePickerModal
                                        ...
                                        />
                                        <TouchableOpacity activeOpacity={1} onPress={() => this.showDatePicker()} style={[profileStyle.createInputView,
                                        { paddingTop: Platform.OS === 'ios' ? 0 : 5, paddingBottom: Platform.OS === 'ios' ? 0 : 5 }]}>
                                            <TextInput
                                                editable={false}
                                                style={[profileStyle.createInputStyle, { width: '93%' }]}
                                    ...
                                    <View style={[profileStyle.editView, { marginTop: 10 }]}>
                                        <Text style={profileStyle.editText}>Gender</Text>
                                        <View style={[profileStyle.createInputView,
                                        { paddingTop: Platform.OS === 'ios' ? 0 : 5, paddingBottom: Platform.OS === 'ios' ? 0 : 5 }]}>
                                            <RNPickerSelect
                                                ...
                                                placeholder={{ label: 'Select Gender', value: 0, placeholderTextColor: 'black', fontFamily: 'HelveticaNeueLTStd-Lt' }}
                                                items={[
                                    ...
                                    <View style={[profileStyle.editView, { marginTop: 10 }]}>
                                        <Text style={profileStyle.editText}>Phone Number</Text>
                                        <View style={[profileStyle.createInputView, { paddingTop: Platform.OS === 'ios' ? 0 : 5, paddingBottom: Platform.OS === 'ios' ? 0 : 5 }]}>
                                        ...
                                        <Text style={profileStyle.selectFlag}>Please select the flag to change the country</Text>

                                    </View>

                                    <View style={[profileStyle.editView, { marginTop: 10 }]}>
                                        <Text style={profileStyle.editText}>Location</Text>
                                    ...
                                    <View style={[profileStyle.editView, { marginTop: 10 }]}>
                                        ...
                                        <Text style={profileStyle.editText}>Address</Text>
                                        <View style={[profileStyle.createInputView]}>
                                            <TextInput
                                                style={profileStyle.createInputStyle}
                                    ...
                                    <TouchableOpacity style={[profileStyle.buttonStyle, { marginTop: 30 }]}
                                        onPress={() => this.updateProfile()}>
                                        <Text style={profileStyle.buttonTextStyle}>Submit</Text>
                                    </TouchableOpacity>
